...
/* harmony import */ var _css_critical_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/critical.scss */ "./css/critical.scss");
...
/* harmony import */ var _modules_PopUpCart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/PopUpCart */ "./src/modules/PopUpCart.js");
/* harmony import */ var _modules_Woocommerce_ProductEnquiry_ProductEnquiry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Woocommerce/ProductEnquiry/ProductEnquiry */ "./src/modules/Woocommerce/ProductEnquiry/ProductEnquiry.js");
...
/***/ "./src/modules/FacetFilter/SortProduct.js":
/*!************************************************!*\
  !*** ./src/modules/FacetFilter/SortProduct.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SortProduct);

/***/ }),

/***/ "./src/modules/FormProcessor/FormProcessor.js":
/*!****************************************************!*\
  !*** ./src/modules/FormProcessor/FormProcessor.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FormProcessor);

/***/ }),

/***/ "./src/modules/GeneralModal.js":
/*!*************************************!*\
  !*** ./src/modules/GeneralModal.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class Header {
  ...
  events() {
    // show phone modal 
    $('.useful-links-container .help-wrapper').hover(e => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PhoneModal);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EveryOwlCarousel);
...
class PopUpCart {
  ...
  removeItem(e) {
    ...
    $.ajax({
      url: webduelData.ajaxurl,
      // Make sure to properly localize your script with the correct ajax URL
      type: 'POST',
      data: {
...
/***/ "./src/modules/QuoteFeature/QuoteAjax.js":
/*!***********************************************!*\
  !*** ./src/modules/QuoteFeature/QuoteAjax.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class QuoteAjax {
  ...
  removeAjaxRequest(productId, row) {
    $.ajax({
      url: webduelData.ajaxurl,
      // Ensure my_ajax_object and ajax_url are correctly defined
      type: 'POST',
      data: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (QuoteAjax);

/***/ }),

/***/ "./src/modules/RevealEffect/RevealEffect.js":
/*!**************************************************!*\
  !*** ./src/modules/RevealEffect/RevealEffect.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/modules/Scroll/FixedNavMobile.js":
/*!**********************************************!*\
  !*** ./src/modules/Scroll/FixedNavMobile.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FixedNavMobile);
...
class Search {
  ...
  sendToShopPage(event) {
    if (event.which === 13) {
      // jQuery normalizes the keyCode value in 'which'
...
/***/ "./src/modules/Woocommerce/AjaxOperation/AjaxAddToCart.js":
/*!****************************************************************!*\
  !*** ./src/modules/Woocommerce/AjaxOperation/AjaxAddToCart.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class AjaxAddToCart {
  ...
  addToCart(e) {
    ...
    const data = {
      ...
      // Make sure to send the variation ID
      quantity: quantity,
      security: webduelData.nonce
    };
  ...
  ajaxRequest(data, $button) {
    // add html in the button 
    $button.html('<div class="dots-loading"></div>');
    $button.siblings('.error-message').hide();
    $.ajax({
      type: 'POST',
      url: webduelData.ajaxurl,
      data: data,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AjaxAddToCart);

/***/ }),

/***/ "./src/modules/Woocommerce/ProductArchive/QuickView.js":
/*!*************************************************************!*\
  !*** ./src/modules/Woocommerce/ProductArchive/QuickView.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/modules/Woocommerce/ProductEnquiry/ProductEnquiry.js":
/*!******************************************************************!*\
  !*** ./src/modules/Woocommerce/ProductEnquiry/ProductEnquiry.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/modules/Woocommerce/QtyHandler/QtyHandler.js":
/*!**********************************************************!*\
  !*** ./src/modules/Woocommerce/QtyHandler/QtyHandler.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (QtyHandler);

/***/ }),

/***/ "./src/modules/Woocommerce/SingleProductTabs.js":
/*!******************************************************!*\
  !*** ./src/modules/Woocommerce/SingleProductTabs.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SingleProductTabs);

/***/ }),

/***/ "./src/modules/Woocommerce/VariationSwatches/VariationSwatches.js":
/*!************************************************************************!*\
  !*** ./src/modules/Woocommerce/VariationSwatches/VariationSwatches.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VariationSwatches);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WooGallery);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkwebduel_theme"] = globalThis["webpackChunkwebduel_theme"] || [];
